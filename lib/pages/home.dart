                                ...
                                if (constraints.maxWidth < 600) {
                                  return GridView.builder(
                                    ...
                                    gridDelegate:
                                      ...
                                      childAspectRatio: 1,
                                      crossAxisSpacing:
                                          0.5, // ajustar valor de espaciado en el eje cruzado (horizontal)
                                      mainAxisSpacing:
                                          0.5, // ajustar valor de espaciado en el eje principal (vertical)
                                    ),
                                    itemCount:
                                  ...
                                  return GridView.builder(
                                    ...
                                    gridDelegate:
                                      ...
                                      childAspectRatio: 1,
                                      crossAxisSpacing:
                                          10, // set to 0 to remove spacing between columns
                                      mainAxisSpacing: 10,
                                    ),
                                    itemCount:
                                        CategoryProvider.categories?.length,
